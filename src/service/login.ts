...
export async function userCreateWithArrayUsingPost({ body, options }: { body: API.UserCreateWithArrayUsingPostBody; options?: CustomRequestOptions }) {
...
export async function userCreateWithListUsingPost({ body, options }: { body: API.UserCreateWithListUsingPostBody; options?: CustomRequestOptions }) {
...
//扫码登录
export async function loginUsingCodePost({ body }: { body: API.ILoginBody }) {
  return request<unknown>('/appCodeForLogin', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
//运营登录
export async function loginUsingPost({ body }: { body: API.ILoginBody }) {
...
//运营发送短信
export async function getSmsCodeUsingPost({ body, options }: { body: API.ISmsCodeBody; options?: CustomRequestOptions }) {
  return request<unknown>('/sendMsgForApp', {
    method: 'POST',
    data: body,
    ...(options || {}),
  })
...
//扫码发送短信
export async function getSmsCodeUsingCodePost({ body, options }: { body: API.ISmsCodeBody; options?: CustomRequestOptions }) {
  return request<unknown>('/sendMsgCode', {
    method: 'POST',
    data: body,
    ...(options || {}),
  })
