...
export function storeInventoryUsingGetQueryOptions(options: { options?: CustomRequestOptions }) {
  return queryOptions({
...
export function useStoreOrderUsingPostMutation(options?: { onSuccess?: (value?: API.Order) => void; onError?: (error?: DefaultError) => void }) {
...
export function useStoreOrderOrderIdUsingDeleteMutation(options?: { onSuccess?: (value?: unknown) => void; onError?: (error?: DefaultError) => void }) {
  const { onSuccess, onError } = options || {}
