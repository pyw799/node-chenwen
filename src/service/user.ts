...
export function listUserAll(query: any = {}) {
  return request<any>('/system/user/listAll', {
    method: 'get',
    params: query || {},
  })
}
...
export function listUser(query: any = {}) {
  return request<any>('/system/user/selectAllUser', {
    method: 'get',
    params: query || {},
  })
}

export function listDeptListApi(query: any = {}) {
  return request<any>('/system/user/deptTree', {
    method: 'get',
    params: query || {},
  })
}
