...
export function useUserUsingPostMutation(options?: { onSuccess?: (value?: unknown) => void; onError?: (error?: DefaultError) => void }) {
...
export function useUserUsernameUsingPutMutation(options?: { onSuccess?: (value?: unknown) => void; onError?: (error?: DefaultError) => void }) {
  const { onSuccess, onError } = options || {}
...
export function useUserUsernameUsingDeleteMutation(options?: { onSuccess?: (value?: unknown) => void; onError?: (error?: DefaultError) => void }) {
  const { onSuccess, onError } = options || {}
...
export function useUserCreateWithArrayUsingPostMutation(options?: { onSuccess?: (value?: unknown) => void; onError?: (error?: DefaultError) => void }) {
  const { onSuccess, onError } = options || {}
...
export function useUserCreateWithListUsingPostMutation(options?: { onSuccess?: (value?: unknown) => void; onError?: (error?: DefaultError) => void }) {
  const { onSuccess, onError } = options || {}
