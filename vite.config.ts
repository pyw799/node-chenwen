...
export default ({ command, mode }) => {
  ...
  const { VITE_APP_PORT, VITE_SERVER_BASEURL, VITE_DELETE_CONSOLE, VITE_SHOW_SOURCEMAP, VITE_APP_PUBLIC_BASE, VITE_APP_PROXY_ENABLE, VITE_APP_PROXY_PREFIX } = env
  ...
  return defineConfig({
    ...
    plugins: [
      UniPages({
        ...
        subPackages: ['src/pages-index'], // 是个数组，可以配置多个，但是不能为pages里面的目录
